...
class Interactive_image(ctk.CTkFrame):
    def __init__(self, root, matrix, width=500, height=500, title = '', subtitle='', font=('American typewriter', 20), subfont=('American typewriter', 14), *args, **kwargs):
        ...
        # Subtitle
        self.subtitle = ctk.CTkLabel(self, text=subtitle, fg_color="transparent", font=subfont)
        if subtitle != '':
            self.subtitle.pack()
