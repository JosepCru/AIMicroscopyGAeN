...
class Frame_settings(ctk.CTkFrame):
    def __init__(self, root, project_path, *args, **kwargs):
        ...
        self.button_save = ctk.CTkButton(self.frame_acquisition, text = 'Save current image', cursor =  'hand2', fg_color='blue', font=('American typewriter', 20))
        ...
        self.button_save.pack(padx = 5, pady = 10, fill = 'x')
